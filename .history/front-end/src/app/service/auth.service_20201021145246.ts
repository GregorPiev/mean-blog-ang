...
export class AuthService {
  ...
  createPost(post): Observable<any> {
    ...
    return this.http.post<any>('http://localhost:3000/account/post', post, { headers: headers })
      .pipe(
        map(res => res)
      );
  }
